    ...
    describe('POST - Create Files', () => {
        ...
        it('should reject  if size property is not include', async () => {
            try {
                ...
                assert.include(
                    err.response.data,
                    "Property 'size' must be a number"
                )
            }
        })
        ...
        it('should reject if updateIndex property is included', async () => {
            try {
                const options = {
                    method: 'POST',
                    url: `${LOCALHOST}/files`,
        ...
        it('should reject if lastAccessed property is included', async () => {
            try {
                const options = {
                    method: 'POST',
                    url: `${LOCALHOST}/files`,
        ...
        it('should create file for admin user with minimum inputs', async function () {
            ...
            assert.property(result.data.file, 'updateIndex')

            // updateIndex is created with the default value 1
            assert.equal(result.data.file.updateIndex, 1)
        })
        ...
        it('should create file with all inputs', async function () {
            ...
            assert.equal(result.data.file.userIdUpload, 'id user')
